...
function App() {
  ...
  return <div className="site">
    ...
    <main id="top">
      ...
      <section id="video" className="video-section"><div className="video-frame"><iframe src="https://player.vimeo.com/video/1313503401?autoplay=1&muted=1&loop=1&autopause=0&background=1" title="Suirside project film" allow="autoplay; fullscreen; picture-in-picture" allowFullScreen></iframe><div className="video-caption"><span>PROJECT FILM</span><strong>St. Stephens National School Development</strong><a href="https://vimeo.com/1313503401" target="_blank" rel="noreferrer">Open film <ArrowUpRight size={16} /></a></div></div></section>
